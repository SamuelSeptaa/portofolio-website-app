...
function generateWhatsAppMe($number)
{

    if (substr($number, 0, 1) === "0") {
        $outputString = "62" . substr($number, 1);
    } else {
        $outputString = $number;
    }
    return "https://api.whatsapp.com/send/?phone=$outputString&text&type=phone_number&app_absent=0";
}
